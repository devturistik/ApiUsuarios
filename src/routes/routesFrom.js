...
router.get("/login", (req, res) => {
  ...
  if (req.session.user) {
    // Asegúrate de que 'user' sea la propiedad que defines para la sesión
  ...
  const errorMessages = {
    "6f6e4c0e2c4d9b54e0dff08b7b5f07a0f953e32b7e6795e7b6e55e87531a5f3d":
      "Correo o contraseña inválidos",
    b9d9a0b530fe478c9e9b9e7d65a87c75da6a65fc9bb3d228b3ae1f84ac972a68:
      "Usuario no encontrado",
    // Agrega más códigos según sea necesario
  };

  const getErrorMessage = (code) =>
    errorMessages[code] || "Ocurrió un error desconocido";
